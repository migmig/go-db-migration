    ...
    <section className="card-surface p-6 dark:bg-slate-800 dark:border-slate-700">
      ...
      <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex gap-2">
           <div className="rounded-lg bg-slate-100 px-3 py-2 text-center dark:bg-slate-900/50">
              <p className="text-[10px] font-bold uppercase text-slate-500 dark:text-slate-400">CPU</p>
              <p className="text-sm font-bold text-slate-700 dark:text-slate-200">{metrics.cpu}</p>
           </div>
           <div className="rounded-lg bg-slate-100 px-3 py-2 text-center dark:bg-slate-900/50">
              <p className="text-[10px] font-bold uppercase text-slate-500 dark:text-slate-400">MEM</p>
              <p className="text-sm font-bold text-slate-700 dark:text-slate-200">{metrics.mem}</p>
           </div>
        </div>
      </div>
